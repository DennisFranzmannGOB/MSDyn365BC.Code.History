...
codeunit 10541 "MTD Fraud Prevention Mgt."
{
    ...
    begin
        ...
        MTDSessionFraudPrevHdr.SafeInsert('Gov-Vendor-Forwarded', StrSubstNo('by=%1&for=%2', vendorIP, clientIP));
    end;
    ...
    begin
        TextValue := UserId();
        exit(StrSubstNo('%1=%2', GetProdName(), TypeHelper.UrlEncode(TextValue)));
    end;
    ...
    begin
        ...
        MTDSessionFraudPrevHdr.SafeInsert(
            'Gov-Client-Screens',
            StrSubstNo(
                'width=%1&height=%2&scaling-factor=1&colour-depth=%3',
        ...
        MTDSessionFraudPrevHdr.SafeInsert(
            'Gov-Client-Window-Size',
            StrSubstNo('width=%1&height=%2', GetJsonValue(JSHeadersJson, 'windowWidth'), GetJsonValue(JSHeadersJson, 'windowHeight')));
    end;
