codeunit 136112 "Working On Service Orders"
{
    ...
    var
        ...
        SplitResourceErrorServiceTier: Label 'Type must be equal to ''Resource''  in Service Line: Document Type=%1, Document No.=%2, Line No.=%3. Current value is ''%4''.';
        ShippedQuantityErrorService: Label 'Quantity Shipped must be equal to ''0''  in Service Line: Document Type=%1, Document No.=%2, Line No.=%3. Current value is ''%4''.';
