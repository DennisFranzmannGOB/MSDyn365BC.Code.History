codeunit 134888 "ERM Application Employee"
{
    ...
    begin
        ...
        for Stepwise := false to true do
            with GenJournalLine do begin
                EmployeeUnrealizedAdjust("Document Type"::Payment, "Document Type"::" ", EmployeeAmount, Stepwise,
                  0.9, DtldEmployeeLedgEntry."Entry Type"::"Realized Gain");
                EmployeeUnrealizedAdjust("Document Type"::" ", "Document Type"::" ", -EmployeeAmount, Stepwise,
                  1.1, DtldEmployeeLedgEntry."Entry Type"::"Realized Gain");
            end;
    end;
