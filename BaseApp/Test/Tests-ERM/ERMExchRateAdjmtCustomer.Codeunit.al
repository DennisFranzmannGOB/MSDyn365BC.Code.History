codeunit 134880 "ERM Exch. Rate Adjmt. Customer"
{
    ...
    begin
        ...
        // [THEN] Verify 2 G/L Entries posted for each of 2 Detailed Customer Ledger Entry, in total 8
        Assert.AreEqual(8, GLEntry.GetLastEntryNo() - LastGLEntryNo, 'incorrect number of G/L entries.');
    end;
