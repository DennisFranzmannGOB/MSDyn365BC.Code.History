codeunit 134988 "ERM Purchase Reports III"
{
    ...
    begin
        with VATEntry do begin
            ...
            LibraryReportValidation.OpenExcelFile();
            LibraryReportValidation.VerifyCellValue(106, 17, LibraryReportValidation.FormatDecimalValue(Base));
            LibraryReportValidation.VerifyCellValue(106, 29, LibraryReportValidation.FormatDecimalValue(Amount));
        end;
    end;
