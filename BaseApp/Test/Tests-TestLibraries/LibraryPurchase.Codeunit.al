codeunit 130512 "Library - Purchase"
{
    ...
    procedure CreatePurchaseLineWithoutVAT(var PurchaseLine: Record "Purchase Line"; PurchaseHeader: Record "Purchase Header"; Type: Enum "Purchase Line Type"; No: Code[20]; Quantity: Decimal)
    begin
        CreatePurchaseLineSimple(PurchaseLine, PurchaseHeader);
