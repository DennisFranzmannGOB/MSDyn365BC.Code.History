codeunit 226 "CustEntry-Apply Posted Entries"
{
    ...
    begin
        ...
        if GLSetup."Journal Templ. Name Mandatory" then begin
            ...
            ApplyUnapplyParameters."Journal Template Name" := JnlTemplateName;
            ApplyUnapplyParameters."Journal Batch Name" := JnlBatchName;
        end;
    ...
    begin
        ...
        if GLSetup."Use Workdate for Appl./Unappl." then begin
            if ApplyUnapplyParameters."Posting Date" > WorkDate() then
                Error(WorkDateErr, ApplyUnapplyParameters."Posting Date");
    ...
    begin
        ...
        if GLSetup."Journal Templ. Name Mandatory" then begin
            ...
            ApplyUnapplyParameters."Journal Template Name" := JournalTemplateName;
            ApplyUnapplyParameters."Journal Batch Name" := JournalBatchName;
        end;
        ApplyUnapplyParameters."Document No." := DocumentNo;
        ApplyUnapplyParameters."Posting Date" := ApplicationDate;
