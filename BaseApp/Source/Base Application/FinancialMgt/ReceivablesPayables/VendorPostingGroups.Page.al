    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the G/L Account No. where the interest transactions shall be posted.';
                }
                field("Non-Taxable"; Rec."Non-Taxable")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies that the posted purchases that are associated with the vendor posting group are not taxable.';
                }
            }
        }
        area(factboxes)
