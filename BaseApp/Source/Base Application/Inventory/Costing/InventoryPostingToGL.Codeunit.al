...
codeunit 5802 "Inventory Posting To G/L"
{
    ...
    begin
        ...
        InvtPostBuf.Correction := ValueEntry."Red Storno";
    ...
    begin
        ...
        repeat
            GenJnlLine.Correction := TempGlobalInvtPostingBuffer.Correction;
    ...
    begin
        ...
        if not ValueEntry0.FindFirst() then
            exit;
        ...
        if ValueEntry0."Source Type" = ValueEntry0."Source Type"::Vendor then begin
            ...
            if ValueEntry0."Source Type" = ValueEntry0."Source Type"::Customer then
    ...
    begin
        ...
        then begin
            ...
            if FALedgerEntry.Get(InvtPostBuf."FA Entry No.") then begin
                ...
                if not FALedgerEntry2.FindFirst() then begin
                    FA.Get(FALedgerEntry2."FA No.");
                    FA.Blocked := false;
                    FA.Modify();
                end;
            end;
