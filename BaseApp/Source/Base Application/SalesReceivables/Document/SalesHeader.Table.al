...
#if not CLEAN21
    [Obsolete('Replaced by event in codeunit PostCodeManagement', '21.0')]
    internal procedure RunOnBeforeFindStreetNameFromSellToAddress(var SalesHeader: Record "Sales Header"; var IsHandled: Boolean)
    begin
