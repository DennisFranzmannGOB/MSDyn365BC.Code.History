...
table 81 "Gen. Journal Line"
{
    ...
    keys
    {
        ...
        {
            IncludedFields = "Document Type", "Document No.";
        }
...
#pragma warning restore AL0432
    ...
    begin
        ...
        if GLSetup."Adjustment Mandatory" then begin
            ...
            GenJournalLine2.SetFilter("Document Type", '%1|%2', GenJournalLine2."Document Type"::"Credit Memo", GenJournalLine2."Document Type"::Refund);
            if GenJournalLine2.FindSet() then
                repeat
                    if GLSetup.GSTEnabled(GenJournalLine2."Document Date") and
