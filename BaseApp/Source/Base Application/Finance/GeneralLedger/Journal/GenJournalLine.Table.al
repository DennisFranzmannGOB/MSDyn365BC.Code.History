...
table 81 "Gen. Journal Line"
{
    ...
    keys
    {
        ...
        {
            IncludedFields = "Debit Amount", "Credit Amount", "Document Type", "Remittance Agreement Code", "Remittance Type", "Remittance Account Code", "Account No.", Urgent, "Futures Contract No.", "Futures Contract Exch. Rate", "Currency Code", "Currency Factor", "Agreed Exch. Rate", "Agreed With", KID;
        }
