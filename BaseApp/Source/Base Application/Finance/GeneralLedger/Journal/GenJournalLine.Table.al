...
table 81 "Gen. Journal Line"
{
    ...
    fields
    {
        ...
        field(11201; "Auto. Acc. Group"; Code[10])
        {
            ...
            begin
                FeatureTelemetry.LogUptake('0001P8X', AccTok, Enum::"Feature Uptake Status"::"Used");
                TestField("Account Type", "Account Type"::"G/L Account");
                FeatureTelemetry.LogUsage('0001P8Y', AccTok, 'Automatic acc generated');
            end;
#endif
        }
    }
...
#pragma warning restore AL0432
...
#if not CLEAN22
    [Scope('OnPrem')]
    [Obsolete('Local features will be moved to TODO: extension name', '22.0')]
    ...
    begin
        ...
        if not IsAutomaticAccountCodesEnabled then
