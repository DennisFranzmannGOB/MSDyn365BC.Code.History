...
codeunit 12 "Gen. Jnl.-Post Line"
{
...
#if not CLEAN19
            // NAVCZ
            if GenJournalLineToPost."Prepmt. Appl. Transaction No." <> 0 then
                if GenJournalLineToPost."Prepmt. Appl. Transaction No." < DetailedCustLedgEntry."Transaction No." then
                    DetailedCustLedgEntry2.SetRange(
                      "Transaction No.", GenJournalLineToPost."Prepmt. Appl. Transaction No.", DetailedCustLedgEntry."Transaction No.")
                else
                    DetailedCustLedgEntry2.SetRange(
                      "Transaction No.", DetailedCustLedgEntry."Transaction No.", GenJournalLineToPost."Prepmt. Appl. Transaction No.")
            else
                // NAVCZ
#endif
    ...
    begin
        ...
        if DetailedVendorLedgEntry."Transaction No." = 0 then begin
            ...
            // NAVCZ
            if GenJournalLineToPost."Prepmt. Appl. Transaction No." <> 0 then
                if GenJournalLineToPost."Prepmt. Appl. Transaction No." < DetailedVendorLedgEntry."Transaction No." then
                    DetailedVendorLedgEntry2.SetRange(
                      "Transaction No.", GenJournalLineToPost."Prepmt. Appl. Transaction No.", DetailedVendorLedgEntry."Transaction No.")
                else
                    DetailedVendorLedgEntry2.SetRange(
                      "Transaction No.", DetailedVendorLedgEntry."Transaction No.", GenJournalLineToPost."Prepmt. Appl. Transaction No.")
            else
                // NAVCZ
#endif
