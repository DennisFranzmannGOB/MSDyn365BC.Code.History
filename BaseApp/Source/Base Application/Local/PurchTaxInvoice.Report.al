...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Local/PurchTaxInvoice.rdlc';
    Caption = 'Purch. - Tax Invoice';

    dataset
    {
        dataitem("Purch. Tax Inv. Header"; "Purch. Tax Inv. Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(PurchTaxInvCopyText; StrSubstNo(Text004, CopyText))
                    {
                    }
                    ...
                    dataitem(VATCounter; "Integer")
                    {
                        ...
                        column(VATRealized_VATAmountLine; TempVATAmountLine."VAT Realized")
                        {
                            AutoFormatExpression = "Purch. Tax Inv. Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(AmountPaid_VATAmountLine; TempVATAmountLine."Amount Paid")
                        {
                            AutoFormatExpression = "Purch. Tax Inv. Header"."Currency Code";
                            AutoFormatType = 1;
                        }
            ...
            begin
                ...
                FormatAddr.PurchTaxInvPayTo(VendAddr, "Purch. Tax Inv. Header");
                ...
                FormatAddr.PurchTaxInvShipTo(ShipToAddr, "Purch. Tax Inv. Header");
    ...
    var
        ...
        PurchTaxInvCountPrinted: Codeunit "Purch. Tax Inv.-Printed";
        ...
        Text003: Label 'COPY';
        Text004: Label 'Purchase - Tax Invoice %1';
