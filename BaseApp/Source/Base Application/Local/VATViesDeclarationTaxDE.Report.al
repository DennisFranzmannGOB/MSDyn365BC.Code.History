report 11007 "VAT-Vies Declaration Tax - DE"
{
    ...
    dataset
    {
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            column(I_don_t__make_use_of_the_regularization_included_in___18a_Abs__1_Satz_2__Caption; IDontMakeUseOfTheRegularizationIncludedIn_18a_Abs_1_Satz_2_InFutureIWillSubmitTheEUSalesListOnAMonthLbl)
            {
            }
    ...
    var
        ...
        TheDataThatIsRequiredInThisSummaryNotificationAreRequiredAccordingToThe_149_GermanFiscalCodeAOAnd_Lbl: Label 'The data that is required in this summary notification\are required according to the ?? 149 etc. German Fiscal Code (AO) and\? 18a UStG.\The statement of phone numbers is optional.';
