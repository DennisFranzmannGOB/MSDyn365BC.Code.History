...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Local/GLCorrespJournalOrder.rdlc';
    ...
    dataset
    {
        dataitem(GLAcc; "G/L Account")
        {
            ...
            column(Text008__FORMAT_DateStartedOfPeriod___Text009_FORMAT_EndingPeriodDate_; Text008 + Format(DateStartedOfPeriod) + Text009 + Format(EndingPeriodDate))
            {
            }
            ...
            column(Journal_OrderCaption; Journal_OrderCaptionLbl)
            {
            }
            ...
            column(Account_Turnover_from_credit_to_debitCaption; Account_Turnover_from_credit_to_debitCaptionLbl)
            {
            }
            ...
            dataitem("Period Month"; "Integer")
            {
                ...
                dataitem("Double Entry"; "G/L Correspondence")
                {
                    ...
                    DataItemTableView = sorting("Credit Account No.", "Debit Account No.");
                    column(Double_Entry__Debit_Account_No__; "Debit Account No.")
                    {
                    }
                    ...
                    column(Double_Entry_Credit_Account_No_; "Credit Account No.")
                    {
                    }
            ...
            dataitem(Total; "Integer")
            {
                ...
                dataitem(TotalAmount; "G/L Correspondence")
                {
                    ...
                    DataItemLinkReference = GLAcc;
                    DataItemTableView = sorting("Credit Account No.", "Debit Account No.");
                    column(TotalAmount__Debit_Account_No__; "Debit Account No.")
                    {
                    }
                    ...
                    column(TotalAmount_Credit_Account_No_; "Credit Account No.")
                    {
                    }
    ...
    var
        ...
        Account_Turnover_from_credit_to_debitCaptionLbl: Label 'Account Turnover from credit to debit';
