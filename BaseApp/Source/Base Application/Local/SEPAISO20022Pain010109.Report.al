...
{
    Caption = 'SEPA ISO20022 Pain 01.01.09';
    ProcessingOnly = true;
    ...
    begin
        FeatureTelemetry.LogUptake('0000N2D', SEPACTExportFile.FeatureName(), Enum::"Feature Uptake Status"::Used);
        FeatureTelemetry.LogUsage('0000N2E', SEPACTExportFile.FeatureName(), 'Report (NL) SEPA ISO20022 Pain 001.001.09');
    end;
