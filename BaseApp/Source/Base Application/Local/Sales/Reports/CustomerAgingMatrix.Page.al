...
page 35461 "Customer Aging Matrix"
{
    ...
    begin
        ...
        DetCustLedgEntry.SetFilter("Customer No.", '%1', Rec."No.");
        DetCustLedgEntry.SetFilter("Initial Entry Due Date", Rec.GetFilter("Date Filter"));
    ...
    begin
        SetDateFilter(MATRIX_ColumnOrdinal);
        DetailedCustLedgEntry.SetFilter("Customer No.", '%1', Rec."No.");
        DetailedCustLedgEntry.SetFilter("Initial Entry Due Date", Rec.GetFilter("Date Filter"));
