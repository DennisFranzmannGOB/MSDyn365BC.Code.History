    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Acc. Schedule Results Nos."; Rec."Acc. Schedule Results Nos.")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group(Advances)
            {
                ...
                field("Use Adv. CM Nos for Adv. Corr."; Rec."Use Adv. CM Nos for Adv. Corr.")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Correction As Storno"; Rec."Correction As Storno")
                {
                    ApplicationArea = Basic, Suite;
