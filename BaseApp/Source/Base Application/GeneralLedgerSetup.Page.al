...
#if not CLEAN20
                field("Jnl. Templ. Name for Applying"; Rec."Jnl. Templ. Name for Applying")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the name of the journal template you want to use for applying customer or vendor ledger entries.';
                    ObsoleteReason = 'Replaced by W1 field Apply Jnl. Template Name in page Gen. Jnl. Posting Setup.';
                    ObsoleteState = Pending;
                    ObsoleteTag = '20.0';
                    Visible = false;
                }
                field("Jnl. Batch Name for Applying"; Rec."Jnl. Batch Name for Applying")
                {
                    ApplicationArea = Basic, Suite;
...
#endif
                field("Payment Recon. Template Name"; Rec."Payment Recon. Template Name")
                {
                    ApplicationArea = Basic, Suite;
