        ...
        area(processing)
        {
            ...
            group("P&osting")
            {
                ...
                action(Printer)
                {
                    ...
                    trigger OnAction()
                    begin
                        PostDocument(CODEUNIT::"Sales-Post + Print", Enum::"Navigate After Posting"::"Posted Document");
                    end;
                }
                action("Email as PDF")
                {
                    ...
                    trigger OnAction()
                    begin
                        PostDocument(CODEUNIT::"Sales-Post + Email", Enum::"Navigate After Posting"::"Posted Document");
                    end;
                }
