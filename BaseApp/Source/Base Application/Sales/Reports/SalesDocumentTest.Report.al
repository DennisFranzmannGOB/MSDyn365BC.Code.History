            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem(CopyLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(VATAmountLine_VATAmountText_Control1130013; TempVATAmountLine.VATAmountText())
                        {
                        }
                        ...
                        column(VATAmountLine_VATAmountText_Control1130001; TempVATAmountLine.VATAmountText())
                        {
                        }
                        ...
                        column(VATAmountLine_VATAmountText_Control1130007; TempVATAmountLine.VATAmountText())
                        {
                        }
                        ...
                        begin
                            ...
                            if "Sales Line"."Gen. Prod. Posting Group" <> '' then begin
                                ...
                                if "Sales Line"."Document Type" in ["Sales Line"."Document Type"::Order, "Sales Line"."Document Type"::Invoice, "Sales Line"."Document Type"::"Credit Memo"] then
                                    if VATPostingSetup.IsEUService("Sales Line"."VAT Bus. Posting Group", "Sales Line"."VAT Prod. Posting Group") then begin
                                        if "Sales Line"."Service Tariff No." = '' then
                                            AddError(
                                              StrSubstNo(
                                                Text006, "Sales Line".FieldCaption("Service Tariff No.")));
                                        if "Sales Line"."Transport Method" = '' then
                                            AddError(
                                              StrSubstNo(
                                         Text12110, "Sales Line".FieldCaption("Transport Method")));
                            ...
                            InclInVATReportErrorLogTemp.SetRange("Line No.", "Sales Line"."Line No.");
                            ...
                            SalesLineHidden := ("Sales Line".Type = "Sales Line".Type::" ") or (("Sales Line"."Quantity (Base)" < 0) and ("Sales Line"."Unit Price" > 0) and ("Sales Line".Amount = 0));
