...
codeunit 365 "Format Address"
{
    ...
    begin
        FormatAddr(
            AddrArray, CompanyInfo."Tax Office Name", CompanyInfo."Tax Office Name 2", '', CompanyInfo."Tax Office Address", CompanyInfo."Tax Office Address 2",
            CompanyInfo."Tax Office City", CompanyInfo."Tax Office Post Code", CompanyInfo."Tax Office County", CompanyInfo."Tax Office Country/Region Code");
    end;
