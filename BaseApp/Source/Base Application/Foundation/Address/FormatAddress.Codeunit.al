...
codeunit 365 "Format Address"
{
    ...
    begin
        FormatAddr(
              AddrArray, CustPmtAddress.Name, CustPmtAddress."Name 2", '', CustPmtAddress.Address, CustPmtAddress."Address 2",
              CustPmtAddress.City, CustPmtAddress."Post Code", CustPmtAddress.County, CustPmtAddress."Country/Region Code");
    end;
