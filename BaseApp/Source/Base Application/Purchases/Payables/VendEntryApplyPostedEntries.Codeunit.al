...
codeunit 227 "VendEntry-Apply Posted Entries"
{
    ...
    begin
            ...
            repeat
                ...
                if DtldVendLedgEntry."Prepmt. Diff." then begin
                    ...
                    AmtDiffManagement.InsertPrepmtDiffBufEntry(
                        DetailedCVLedgEntryBuffer, Enum::"General Posting Type"::Purchase.AsInteger(), DtldVendLedgEntry."Transaction No.");
                end;
            until DtldVendLedgEntry.Next() = 0;
        ...
        GenJnlLine."System-Created Entry" := true;
        GenJnlLine."Agreement No." := DtldVendLedgEntry2."Agreement No.";
        if GLSetup."Journal Templ. Name Mandatory" then begin
