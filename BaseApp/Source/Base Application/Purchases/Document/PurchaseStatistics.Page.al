...
#pragma warning restore AA0100
    ...
    begin
        ...
        TotalAmount1ACY := TempVATAmountLine.GetTotalLineAmountACY();
        VATAmountACY := TempVATAmountLine.GetTotalVATAmountACY();
        TotalAmount2ACY := TotalAmount1ACY + VATAmountACY;

        OnAfterUpdateHeaderInfo();
    end;

    protected procedure GetVATSpecification()
    begin
    ...
    protected procedure SetVATSpecification()
    begin
